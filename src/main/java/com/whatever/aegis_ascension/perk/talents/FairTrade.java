...
import static com.whatever.aegis_ascension.perk.TalentConstants.SR_FAIR_TRADE;
...
public final class FairTrade {
    ...
    public static double damageBonus(double successfulTrades) {
        Perk fairTrade = Perk.byId(SR_FAIR_TRADE).orElseThrow();
