...
public final class CustomStats {
    private static final List<Definition> DEFINITIONS = List.of(
            ...
            stat(ALL_SKILL_ENHANCEMENT_ATTRIBUTE, R_NOELLE, Format.PERCENT),
            stat(BREAKTHROUGH_EFFECT, SR_PLANA, Format.PERCENT),
            stat(FINAL_DAMAGE, R_KOKONA, Format.PERCENT),
            soulStat(
                    INDEPENDENT_DAMAGE_AMPLIFICATION,
                    SOUL_LOVE_AS_ETERNAL_AS_THIS_MOMENT,
                    Format.PERCENT
            ),
            stat(DAMAGE_BONUS, SSR_BECAUSE_YOU_EXIST_AS_I_WRITE, Format.PERCENT),
            stat(MAGIC_DAMAGE, R_MAGIC_BLADE, Format.PERCENT),
            stat(PHYSICAL_DAMAGE_AMPLIFICATION, R_FLICKERING_LIGHT, Format.PERCENT),
            stat(SPELL_DAMAGE_AMPLIFICATION, SR_MASTER_SPARK, Format.PERCENT),
            stat(SKILL_DAMAGE, R_SKILL_DAMAGE_CONVERSION, Format.PERCENT),
            stat(TRUE_DAMAGE, SSR_SEVEN_COLORED_MAGICIAN, Format.PERCENT),
            stat(HEALTH_REGENERATION, R_HEALING_MAGIC, Format.PERCENT),
            stat(MANA_REGENERATION, R_MAGIC_BLADE, Format.PERCENT),
            stat(HEALING_POWER, SSR_BLESSING_OF_THE_WORLD_TREE, Format.PERCENT),
            stat(SUMMON_POWER, R_NOELLE, Format.PERCENT),
            stat(SUMMON_COUNT, SSR_PLATEAU_WITCH, Format.INTEGER),
            stat(CRITICAL_CHANCE, R_INK_DYED_SAKURA, Format.PERCENT),
            stat(CRITICAL_DAMAGE, R_HALF_HUMAN_HALF_PHANTOM_GARDENER, Format.PERCENT),
            stat(LUCK, R_ALICE, Format.NUMBER),
            stat(LUCKY_STRIKE, R_LUCKY_ARROW, Format.PERCENT),
            stat(PRIMARY_ATTRIBUTE_FLAT, R_ARONA, Format.NUMBER),
            stat(ATTACK_RANGE, SR_WIND_ARROW, Format.NUMBER),
            stat(COOLDOWN_REDUCTION, R_NINGNING_CIALLO, Format.PERCENT),
            stat(INDEPENDENT_SKILL_DAMAGE, R_HAYASE_YUKA, Format.PERCENT),
            stat(INDEPENDENT_SKILL_AREA, R_OTOGI_NOAH, Format.PERCENT),
            stat(DAMAGE_REDUCTION, SR_BEATER, Format.PERCENT),
            stat(SHIELD_GAIN, SR_KOHARU_SPRITE, Format.PERCENT),
            stat(REVIVES_REMAINING, R_BOUNDARY_OF_LIFE_AND_DEATH, Format.INTEGER),
            stat(TALENT_OPTION_BONUS, SR_FLOWER_FAIRY, Format.INTEGER),
